...
Analyser Visualiser Plugin (AVP)
==================================
...
About AVP
=================   
As of now QGIS has not been incorporated any analysis tools.
...
The plugin provides benefit to both the software’s – an analysis tools for QGIS and a way to visualize the results given out by SaTScan.
